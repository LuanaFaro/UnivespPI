...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(69137237526221422072)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137237822241422072)
,p_plug_template_id=>wwv_flow_imp.id(69137237526221422072)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137238135585422072)
,p_plug_template_id=>wwv_flow_imp.id(69137237526221422072)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137238411394422072)
,p_plug_template_id=>wwv_flow_imp.id(69137237526221422072)
,p_name=>'Sub Regions'
