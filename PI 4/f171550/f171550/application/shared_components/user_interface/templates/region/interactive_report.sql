...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(69137286631746422093)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137286964513422093)
,p_plug_template_id=>wwv_flow_imp.id(69137286631746422093)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137287285179422093)
,p_plug_template_id=>wwv_flow_imp.id(69137286631746422093)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137287594560422093)
,p_plug_template_id=>wwv_flow_imp.id(69137286631746422093)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137287813780422093)
,p_plug_template_id=>wwv_flow_imp.id(69137286631746422093)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137288127581422093)
,p_plug_template_id=>wwv_flow_imp.id(69137286631746422093)
,p_name=>'Sub Regions'
