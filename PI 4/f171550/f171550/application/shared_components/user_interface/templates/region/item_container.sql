...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(69137288720635422094)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137289086596422094)
,p_plug_template_id=>wwv_flow_imp.id(69137288720635422094)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137289329879422094)
,p_plug_template_id=>wwv_flow_imp.id(69137288720635422094)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137289608180422094)
,p_plug_template_id=>wwv_flow_imp.id(69137288720635422094)
,p_name=>'Button Start'
