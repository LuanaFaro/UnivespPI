...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(69137266628920422085)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137266939224422085)
,p_plug_template_id=>wwv_flow_imp.id(69137266628920422085)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137267218900422085)
,p_plug_template_id=>wwv_flow_imp.id(69137266628920422085)
,p_name=>'Sub Regions'
