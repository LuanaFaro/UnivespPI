...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(69137291274685422095)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137291536036422095)
,p_plug_template_id=>wwv_flow_imp.id(69137291274685422095)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137291828732422095)
,p_plug_template_id=>wwv_flow_imp.id(69137291274685422095)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137292185096422095)
,p_plug_template_id=>wwv_flow_imp.id(69137291274685422095)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137292446734422095)
,p_plug_template_id=>wwv_flow_imp.id(69137291274685422095)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137292745933422095)
,p_plug_template_id=>wwv_flow_imp.id(69137291274685422095)
,p_name=>'Sub Regions'
