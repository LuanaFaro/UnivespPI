...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(69137231849499422070)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137232188930422070)
,p_plug_template_id=>wwv_flow_imp.id(69137231849499422070)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137232414876422070)
,p_plug_template_id=>wwv_flow_imp.id(69137231849499422070)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137232770905422070)
,p_plug_template_id=>wwv_flow_imp.id(69137231849499422070)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137233072454422070)
,p_plug_template_id=>wwv_flow_imp.id(69137231849499422070)
,p_name=>'Sub Regions'
