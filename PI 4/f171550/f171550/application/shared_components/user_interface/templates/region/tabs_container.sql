...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(69137306251582422101)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137306504198422101)
,p_plug_template_id=>wwv_flow_imp.id(69137306251582422101)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137306875338422101)
,p_plug_template_id=>wwv_flow_imp.id(69137306251582422101)
,p_name=>'Tabs'
