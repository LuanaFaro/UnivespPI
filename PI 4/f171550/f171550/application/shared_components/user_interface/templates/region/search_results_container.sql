...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(69137293743302422096)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137294082418422096)
,p_plug_template_id=>wwv_flow_imp.id(69137293743302422096)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137294372159422096)
,p_plug_template_id=>wwv_flow_imp.id(69137293743302422096)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137294615230422096)
,p_plug_template_id=>wwv_flow_imp.id(69137293743302422096)
,p_name=>'Sub Regions'
