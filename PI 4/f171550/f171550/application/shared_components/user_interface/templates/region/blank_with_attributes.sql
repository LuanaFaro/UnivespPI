...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(69137230390770422069)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137230666280422069)
,p_plug_template_id=>wwv_flow_imp.id(69137230390770422069)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137230937482422069)
,p_plug_template_id=>wwv_flow_imp.id(69137230390770422069)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137231281605422069)
,p_plug_template_id=>wwv_flow_imp.id(69137230390770422069)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137231643432422070)
,p_plug_template_id=>wwv_flow_imp.id(69137230390770422069)
,p_name=>'Sub Regions'
