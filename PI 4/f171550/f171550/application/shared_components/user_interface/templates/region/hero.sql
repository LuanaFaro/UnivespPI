...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(69137263484847422083)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137263738549422083)
,p_plug_template_id=>wwv_flow_imp.id(69137263484847422083)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137264085324422084)
,p_plug_template_id=>wwv_flow_imp.id(69137263484847422083)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137264310998422084)
,p_plug_template_id=>wwv_flow_imp.id(69137263484847422083)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137264655687422084)
,p_plug_template_id=>wwv_flow_imp.id(69137263484847422083)
,p_name=>'Sub Regions'
