...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(69137215041946422062)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137215318184422062)
,p_page_template_id=>wwv_flow_imp.id(69137215041946422062)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137215645869422062)
,p_page_template_id=>wwv_flow_imp.id(69137215041946422062)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137215965183422062)
,p_page_template_id=>wwv_flow_imp.id(69137215041946422062)
