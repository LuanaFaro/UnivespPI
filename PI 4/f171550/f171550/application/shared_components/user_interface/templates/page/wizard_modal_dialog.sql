...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(69137223646271422066)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137223927425422066)
,p_page_template_id=>wwv_flow_imp.id(69137223646271422066)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137224228458422066)
,p_page_template_id=>wwv_flow_imp.id(69137223646271422066)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137224577335422066)
,p_page_template_id=>wwv_flow_imp.id(69137223646271422066)
