...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(69137205024525422057)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137205347749422057)
,p_page_template_id=>wwv_flow_imp.id(69137205024525422057)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137205634469422058)
,p_page_template_id=>wwv_flow_imp.id(69137205024525422057)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137205911155422058)
,p_page_template_id=>wwv_flow_imp.id(69137205024525422057)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69137206215321422058)
,p_page_template_id=>wwv_flow_imp.id(69137205024525422057)
,p_name=>'Body Footer'
