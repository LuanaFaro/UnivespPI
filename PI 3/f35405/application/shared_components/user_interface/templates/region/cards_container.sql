...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(34219637934656841602)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2388028500663038303)
,p_plug_template_id=>wwv_flow_imp.id(34219637934656841602)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2388028609556038303)
,p_plug_template_id=>wwv_flow_imp.id(34219637934656841602)
,p_name=>'Sub Regions'
