...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(34219676329710841618)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2388020258434038303)
,p_plug_template_id=>wwv_flow_imp.id(34219676329710841618)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2388020473928038303)
,p_plug_template_id=>wwv_flow_imp.id(34219676329710841618)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2388020533658038303)
,p_plug_template_id=>wwv_flow_imp.id(34219676329710841618)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2388020587008038303)
,p_plug_template_id=>wwv_flow_imp.id(34219676329710841618)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(34219676603478841618)
,p_plug_template_id=>wwv_flow_imp.id(34219676329710841618)
