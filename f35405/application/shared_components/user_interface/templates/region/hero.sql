...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(34219655928962841609)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2388025662367038303)
,p_plug_template_id=>wwv_flow_imp.id(34219655928962841609)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2388025716016038303)
,p_plug_template_id=>wwv_flow_imp.id(34219655928962841609)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2388025798259038303)
,p_plug_template_id=>wwv_flow_imp.id(34219655928962841609)
,p_name=>'Next'
,p_placeholder=>'NEXT'
