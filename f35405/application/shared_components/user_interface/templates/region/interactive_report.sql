...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(34219663827714841612)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2388023621292038303)
,p_plug_template_id=>wwv_flow_imp.id(34219663827714841612)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2388023693740038303)
,p_plug_template_id=>wwv_flow_imp.id(34219663827714841612)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2388023839290038303)
,p_plug_template_id=>wwv_flow_imp.id(34219663827714841612)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2388023920140038303)
,p_plug_template_id=>wwv_flow_imp.id(34219663827714841612)
,p_name=>'Previous'
