...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(34219672565090841616)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(34219672843337841616)
,p_plug_template_id=>wwv_flow_imp.id(34219672565090841616)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(34219673121148841616)
,p_plug_template_id=>wwv_flow_imp.id(34219672565090841616)
,p_name=>'Tabs'
