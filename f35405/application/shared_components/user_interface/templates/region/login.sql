...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(34219664383703841613)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2388023224026038303)
,p_plug_template_id=>wwv_flow_imp.id(34219664383703841613)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2388023342423038303)
,p_plug_template_id=>wwv_flow_imp.id(34219664383703841613)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2388023445942038303)
,p_plug_template_id=>wwv_flow_imp.id(34219664383703841613)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2388023528738038303)
,p_plug_template_id=>wwv_flow_imp.id(34219664383703841613)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(34219664761397841613)
,p_plug_template_id=>wwv_flow_imp.id(34219664383703841613)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>false
