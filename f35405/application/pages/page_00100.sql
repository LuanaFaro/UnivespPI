...
,p_last_upd_yyyymmddhh24miss=>'20221119131440'
);
...
'<img src="#APP_FILES#projetodoacao.jpeg" style="width:100%;height:100%">',
''))
...
,p_include_in_reg_disp_sel_yn=>'Y'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>O <strong>Projeto DoA&ccedil;&atilde;o</strong> &eacute; uma iniciativa dos graduandos em computa&ccedil;&atilde;o da Universidade Virtual do Estado&nbsp;de S&atilde;o Paulo (UNIVESP) - Polo de Caraguatatuba, com o objetivo de amenizar a dificulda'
||'de das pessoas em realizar doa&ccedil;&otilde;es, agrupando informa&ccedil;&otilde;es de institui&ccedil;&otilde;es que aceitam doa&ccedil;&otilde;es, desta maneira o doador pode&nbsp;encontrar com mais facilidade onde doar seus pertences.</p>',
'',
'<p>O <strong>Projeto DoA&ccedil;&atilde;o</strong> disponibiliza um Web Service com os dados das institui&ccedil;&otilde;es cadastradas no portal, <strong><a href="https://apex.oracle.com/pls/apex/univesp_pi/projetodoacao/instituicoes" target="_blank'
||'">clique aqui</a></strong> para visualizar a solu&ccedil;&atilde;o.</p>',
'',
'<p>Al&eacute;m da vers&atilde;o Web os usu&aacute;rios podem fazer a instala&ccedil;&atilde;o do aplicativo clicando no bot&atilde;o abaixo:</p>',
''))
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(14492526934700460710)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(28778815408523289994)
,p_button_name=>'Instalar_App'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:t-Button--iconRight'
,p_button_template_id=>wwv_flow_imp.id(34219730962669841643)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Instalar App'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(14492526765695460708)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>unistr('Login Instala\00E7\00E3o')
